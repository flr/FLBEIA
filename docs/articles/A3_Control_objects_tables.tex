    ...
    \begin{threeparttable}
      ...
      \begin{tabular}{lllll} %{c|c}
        ...
        {[[st]]}\$indObs[[id]]\$indObs.model\textsuperscript{*} & character & 1 & \texttt{'NoObsIndex'},\texttt{'NoObservation'},\texttt{'ageInd'},
          \texttt{'bioInd'}, &  \\
         &  &  & \texttt{'ssbInd'},\texttt{'cbbmInd'} &  \\ % specific for ANE: ssbInd and cbbmInd
        % +++ SONIA To be also included: ,\texttt{'bio1plusInd'}
  ...
  \begin{footnotesize}
    ...
    \begin{threeparttable}
      ...
      \begin{tabular}{lllll} %{c|c}
        ...
        {[[st]]}\$work\_w\_Iter\textsuperscript{*} & logical & 1 & \texttt{'TRUE'} (if assessment model deals with iterations) &  \texttt{assess.ctrl[[st]]\$assess.model != 'NoAssessment'}\\
        % changes in assessment periods (e.g. in the middle of the year
        ...
        {[[st]]}\$ass.season & character & 1 & NULL (assessment in the last season is assumed),  &  \\
         &  &  & season.name &  \\
        {[[st]]}\$harvest.units & character & 1 & \texttt{'f'},\texttt{'hr'} & \texttt{assess.ctrl[[st]]\$assess.model != 'NoAssessment'} \\
