    ...
    \begin{threeparttable}
      ...
      \begin{tabular}{lllll} %{c|c}
        ...
        fls.data & &	list & number of fleets &	List with the name of the fleets and the following elements:\\
          & fl.met      & vector &	number of m\'etiers in 'fl' &	Name of the m\'etiers in the fleet 'fl'\\
...
\begin{table}[!ht]
  ...
  \begin{footnotesize}
    ...
    \caption{Description of the arguments for \texttt{create.obs.ctrl} function.
    In the table we assume that \texttt{st} is the name of the stock and \texttt{id} is the name of the index.
...
\begin{table}[!ht]
  ...
  \begin{footnotesize}
    ...
    \caption{Description of the arguments for \texttt{create.advice.ctrl} function.
    In the table we assume that \texttt{st} is the name of the stock.
    %and \texttt{fl} the name of the fleet.
    The arguments with \textsuperscript{*} are compulsory arguments.}
